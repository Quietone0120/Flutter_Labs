...
# ── Har Suld SFX ─────────────────────────────────────────────────────────────
# Arrow whoosh — quick sweep up then fade
make_wav("sfx_hs_arrow.wav",      freq=800, freq2=1600, duration=0.14, wave_type='sweep',  volume=0.50)
# Enemy killed — low thud + decay
make_wav("sfx_hs_kill.wav",       freq=100, freq2=40,   duration=0.35, wave_type='noise',  volume=0.78)
# Wave start — rising alarm drum
make_wav("sfx_hs_wave_start.wav", freq=120, freq2=240,  duration=0.50, wave_type='sweep',  volume=0.85)
# Wave complete — ascending resolution chord
make_wav("sfx_hs_wave_end.wav",   freq=440, freq2=660,  duration=0.55, wave_type='sine',   volume=0.72)
# Player hurt — sharp hit
make_wav("sfx_hs_hurt.wav",       freq=180, freq2=80,   duration=0.30, wave_type='sweep',  volume=0.80)
# Structure placed — wooden thud
make_wav("sfx_hs_build.wav",      freq=200, freq2=120,  duration=0.22, wave_type='noise',  volume=0.60)
# Har Suld hit — deep resonant impact
make_wav("sfx_hs_harsuld_hit.wav",freq=60,  freq2=30,   duration=0.55, wave_type='noise',  volume=0.90)
# Game over — somber descending
make_wav("sfx_hs_gameover.wav",   freq=300, freq2=80,   duration=0.90, wave_type='sweep',  volume=0.82)
# Harvest resource — light ping
make_wav("sfx_hs_harvest.wav",    freq=700, freq2=900,  duration=0.18, wave_type='sweep',  volume=0.45)
